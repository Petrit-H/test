...
fetchClientIp().then(({ countryCode, ipFrom, browser }) => {
  CountryCode = countryCode;
  responseJSON = { ...responseJSON, ipAddress: ipFrom, browserAgent: browser };
...
// fetchClientIp().then(({countryCode}) => {
//   CountryCode = countryCode;
//   ccInstance = new CookieConsent(optionsObj(countryCode, testType));
//   ccInstance.autoOpen = true;
//   ccInstance
